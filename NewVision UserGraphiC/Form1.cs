...
namespace NewVision_UserGraphiC
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Open file eroor", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                MessageBox.Show(ex.Message, "Create file error", MessageBoxButtons.OK, MessageBoxIcon.Error);
